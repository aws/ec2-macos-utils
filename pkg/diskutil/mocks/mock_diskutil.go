...
import (
	...
	diskutil "github.com/aws/ec2-macos-utils/pkg/diskutil"
...
func (m *MockDiskUtil) Info(id string) (*diskutil.DiskInfo, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Info", id)
	ret0, _ := ret[0].(*diskutil.DiskInfo)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockDiskUtil) List(args []string) (*diskutil.SystemPartitions, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "List", args)
	ret0, _ := ret[0].(*diskutil.SystemPartitions)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
